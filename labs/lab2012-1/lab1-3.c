...
GLfloat vertices[] = { 0.0f,0.0f,0.0f, 0.5f,0.5f,0.0f, 0.5f,0.0f,0.0f };
...
void display(void)
{
	printError("pre display");
        ...
        myRotMat[0] = cosf(0.001*t);
        myRotMat[1] = -sinf(0.001*t);
        myRotMat[4] = sinf(0.001*t);
        myRotMat[5] = cosf(0.001*t);
...
int main(int argc, const char *argv[])
{
	...
	glutCreateWindow ("GL3 red rotating triangle example");
